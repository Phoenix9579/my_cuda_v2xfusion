...
def kitti_visual_tool(data_root, demo_dir):
    ...
    for image_file in os.listdir(image_path):
        image_ids.append(image_file.split(".")[0])#提取文件名（不包括扩展名）并添加到 image_ids 列表中。
